        ...
        >
          ...
          {showPop && (
            ...
            >
              <button
                type="button"
                className="absolute right-0 top-0 z-20 flex h-8 w-8 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border text-xl leading-none shadow-[0_8px_20px_rgba(0,0,0,0.22)]"
                style={{
